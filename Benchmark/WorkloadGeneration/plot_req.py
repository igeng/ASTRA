...
# 保存图表（可选）
plt.savefig('concurrent_users_over_time.svg', format='svg', dpi=900, bbox_inches='tight')
plt.savefig('concurrent_users_over_time.pdf', format='pdf', dpi=900, bbox_inches='tight')
